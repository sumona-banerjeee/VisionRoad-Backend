...
class YoloeTrainedVlDetector(YoloDetector):
    ...
    def __init__(self):
        # YoloDetector only accepts verify_fn and detection_mode.
        # The trained model is loaded via the _load_model() override below.
        # The 0.70 confidence threshold is enforced inside process_with_trained_vl.
        super().__init__(
