...
# ── Input / Output paths ──
INPUT_SOURCE = r"Test\video\live-vid-3.mp4"
OUTPUT_PATH  = r"output\output-prompt-7.mp4"

# ── Open-vocabulary text prompts ──
TARGET_PROMPTS = [
    # ── Good / Intact Signboards ──
    "clean intact traffic sign",
    "clear visible road sign",
    "good condition traffic signboard",

    # ── Damaged / Defective Signboards ──
    "damaged traffic signboard",
    "broken traffic signboard",
    "faded colorless white blank signboard",
    "rusted signboard",
    "bent traffic signboard",
    "graffiti covered signboard",
    "cracked traffic sign",

    # ── Circular Signs ──
    "damaged circular round traffic sign",
    "faded circular round traffic sign",
    "broken circular round traffic sign",
    "clean circular round traffic sign",
